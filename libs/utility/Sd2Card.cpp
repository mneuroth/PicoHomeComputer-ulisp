...
#define USE_SPI_LIB
#include <Arduino.h>
#include "libs/utility/Sd2Card.h"
//------------------------------------------------------------------------------
#ifndef SOFTWARE_SPI
#ifdef USE_SPI_LIB
...
#else
  #include <SoftSPI.h>
  SoftSPI SDCARD_SPI(PICO_HOME_COMPUTER_CS_SDCARD_PIN,MOSI,MISO,SCK);
#endif  
#endif
...
//PATCH    SDCARD_SPI.endTransaction();
  }
  #endif
}
//------------------------------------------------------------------------------
...
//PATCH    SDCARD_SPI.beginTransaction(settings);
  }
  #endif
...
uint8_t Sd2Card::init(uint8_t sckRateID, uint8_t chipSelectPin) {
  ...
  #else // USE_SPI_LIB
  SDCARD_SPI.begin();
//PATCH  settings = SPISettings(250000, MSBFIRST, SPI_MODE0);
  #endif // USE_SPI_LIB
  #endif // SOFTWARE_SPI
...
//PATCH  settings = SPISettings(clock, MSBFIRST, SPI_MODE0);
  return true;
}
#endif
//------------------------------------------------------------------------------
