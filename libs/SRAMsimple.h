...
#include <SoftSPI.h>
/*
class MySoftSPI : public SoftSPI
{
public: 
    MySoftSPI(uint8_t pinSSt, uint8_t pinMOSIt, uint8_t pinMISOt, uint8_t pinSCKt) 
       : SoftSPI(pinSSt, pinMOSIt, pinMISOt, pinSCKt)
    {
      
    }
//    inline void transfer(void *buf, size_t count) {
      //transfer((uint16_t)count, (uint8_t *)buf);
//    }
};
extern MySoftSPI SPI;
*/
//extern SoftSPI SPI;
